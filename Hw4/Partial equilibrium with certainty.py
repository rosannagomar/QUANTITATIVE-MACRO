# -*- coding: utf-8 -*-
"""
Created on Tue Dec  8 12:31:32 2020
...
sigma_y = 0           #parameter for income shock
...
plt.plot(assets, consumption_good, color="green", label = 'Optimal consumption for positive shock')
plt.title('Policy rule for consumption, infinite horizon (quadratic utility)')
plt.ylim([0, 15])
plt.legend()
...
assets_bad = assets[g[0:100]]     # optimal decision of assets 

g_assets_bad = g[0:100]

simulation[0]  = g_assets_bad[99] # our initial guess of assets  (a0)

for i in range(1, 45):
    
        simulation[i] = g_assets_bad[int(simulation[i-1])]
        
for i in range(0, 44):
    
        simulation[i] = g_assets_bad[int(simulation[i])]
...
plt.plot(assets, C40, label = 'Consumption for T=40')
plt.title('Policy rule for consumption, T=45, quadratic preferences')
plt.legend()
plt.ylabel('Consumption')
plt.xlabel('Assets')
plt.show()
...
plt.figure()
plt.plot(assets, consumption_bad, '.',color="red", label = 'Optimal consumption for bad shock')
plt.plot(assets, consumption_good, color="black", label = 'Optimal consumption for positive shock')
plt.title('Policy rule for consumption,infinite horizon (CRRA utility)')
plt.legend()
plt.ylabel('Consumption')
plt.ylim([0, 4])
plt.xlabel('Assets')
...
plt.figure()
plt.plot(t, simulation[0:44],color="red", label = 'Assets ')
...
plt.figure()
plt.plot(t[0:43], c[0:43], color="red", label = 'Consumption')
...
plt.title('Policy rule for consumption, T=45, CRRA preferences')
plt.legend()
plt.ylabel('Consumption')
plt.xlabel('Assets')
plt.show()
